...
# Project:  example.pro
# Template: app
# Command: /usr/lib/i386-linux-gnu/qt5/bin/qmake -o Makefile example.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) `pkg-config opencv --libs` -I/usr/local/include/tesseract -L/usr/lib -llept -ltesseract -lQt5Widgets -L/usr/lib/i386-linux-gnu -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: example.pro /usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/i386-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/example1.0.0 || mkdir -p .tmp/example1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/example1.0.0/ && $(COPY_FILE) --parents square.h .tmp/example1.0.0/ && $(COPY_FILE) --parents main.cpp square.cpp .tmp/example1.0.0/ && (cd `dirname .tmp/example1.0.0` && $(TAR) example1.0.0.tar example1.0.0 && $(COMPRESS) example1.0.0.tar) && $(MOVE) `dirname .tmp/example1.0.0`/example1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/example1.0.0
...
square.o: square.cpp mainwindow.h \
		/usr/include/qt5/QtWidgets/QMainWindow \
		/usr/include/qt5/QtWidgets/qmainwindow.h \
		/usr/include/qt5/QtWidgets/qwidget.h \
		/usr/include/qt5/QtGui/qwindowdefs.h \
